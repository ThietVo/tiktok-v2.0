...
function ModalEditProfile() {
  ...
  const handleChangeTiktokId = (e) => {
    ...
    filterUsersByTiktokId(value).then((result) => {
      if (result.length > 0) {
        setIsExist(true);
      } else {
        setIsExist(false);
    ...
    <Modal>
      <div className={styles.profile}>
        ...
        <div className={styles.profileHeader}>
          ...
          <button
            className={styles.profileHeaderClose}
            ...
            <div className={styles.profileBodyItemAreaContainer}>
              <div className={styles.profileBodyItemAreaContainerTiktokid}>
                ...
                {isExist === null ? (
                  ...
                  <BiError
                    className={styles.profileBodyItemAreaContainerTiktokidError}
                  />
                ) : (
                  <MdCheck
                    className={styles.profileBodyItemAreaContainerTiktokidCheck}
                  />
                )}
              </div>
        ...
        <div className={styles.profileFooter}>
          <button
            className={styles.profileFooterCancel}
