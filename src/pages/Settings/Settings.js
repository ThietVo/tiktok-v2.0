            ...
            <div className={styles.content}>
                <div className={styles.accountManager}>
                    ...
                    <div>
                        ...
                        <div className={styles.subTitle}>Xóa Tài khoản</div>
                    </div>
                </div>
                <div className={styles.privacy}>
                    ...
                    <div>
                        ...
                        <div className={styles.subTitle}>Tài khoản riêng tư</div>
                    ...
                    <div>
                        <div className={styles.subTitle}>Tài khoản bị chặn</div>
                    </div>
                ...
                <div className={styles.notification}>
                    ...
                    <div>
                        ...
                        <div className={styles.subTitle}>Cho phép trong trình duyệt</div>
                        <div className={styles.desc}>
                    ...
                    <div>
                        ...
                        <div className={styles.desc}>
                            Lượt thích, bình luận, follower mới, lượt nhắc đến
                        </div>
                    </div>
                </div>
            </div>
